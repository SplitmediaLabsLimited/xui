...
(function()
{
    ...
    const COLOR_PATTERN = /#([0-9A-F]{6}$)|#([0-9A-F]{3}$)/i;
    ...
    */
    XUIColorpicker.prototype =
    {
        ...
        {           
            var isOk  = COLOR_PATTERN.test(newValue);
        ...
        onInputKeydown: function(event)
        {
            if (event.which == 13)
            {
                var isOk  = COLOR_PATTERN.test("#" + this.$.inputColor.value);                              
                if (!isOk)
                {
                    if (this.allowTransparent && this.$.inputColor.value == '')
                    {

                    }
                    else
                    {
                        this.$.inputColor.value = this.oldvalue.replace('#','');
                    }
                }
                if ( this.$.inputColor.value.length != 3)
                {
                    this.$.inputColor.value = (this.$.inputColor.value).toUpperCase();
                }
                else
                {
                    this.$.inputColor.value = (this.$.inputColor.value.charAt(0) + this.$.inputColor.value.charAt(0) + this.$.inputColor.value.charAt(1) + this.$.inputColor.value.charAt(1) + this.$.inputColor.value.charAt(2) + this.$.inputColor.value.charAt(2)).toUpperCase();
                }
